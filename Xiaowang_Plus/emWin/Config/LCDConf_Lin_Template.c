...
*                3. 修改本文件中函数LCD_LL_Init里面的时序参数。
*
*	修改记录 :
*		版本号    日期         作者        说明
*		V1.0    2019-05-25    Eric2013     首发
*		V2.0    2021-01-03    Eric2013     适配ARGB和ABGR两种格式库
*
*
...
static U32 _aBuffer[XSIZE_PHYS];
...
#else
static U32 	_pBuffer_DMA2D[XSIZE_PHYS];
//static U32 	_pBuffer_FG   [XSIZE_PHYS];
//static U32 	_pBuffer_BG   [XSIZE_PHYS];
#endif
...
int LCD_X_DisplayDriver(unsigned LayerIndex, unsigned Cmd, void * pData) 
{
	...
	switch (Cmd) 
	{
		...
		case LCD_X_SETALPHA: 
		{
         ...
         #else
            HAL_LTDC_SetAlpha(&hltdc, 255-p->Alpha, LayerIndex);
         #endif
			break;
		}
