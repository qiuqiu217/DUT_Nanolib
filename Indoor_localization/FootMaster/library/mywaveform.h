...
class MyWaveform : public QCustomPlot
{
public:
    explicit MyWaveform(QObject *parent = nullptr);


    QMap<QString, QCPGraph*> m_curves;//使用一个map管理各条曲线
    ...
    QVector<QColor> baseColors = { QColor(255, 0, 0), QColor(0, 0, 255),QColor(0, 128, 0),
                                   QColor(255, 165, 0), QColor(219, 112, 147),QColor(75, 0, 130),
